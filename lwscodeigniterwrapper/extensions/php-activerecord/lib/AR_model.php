...
class AR_model
{
	...
	public function assign_attribute($name, $value)
	{
		...
		if ($value instanceof DateTime)
			$value = new ARDateTime($value->format('Y-m-d H:i:s T'));
		...
		if ($value instanceof ARDateTime)
	 ...
	 * @param AR_model $model
	 * @param $name of relationship for this table
	 * @return void
	 */
	public function set_relationship_from_eager_load(AR_model $model=null, $name)
	{
		$table = static::table();
	 ...
	 *
	 * @see find
	 * @return AR_model The first matched record or null if not found
	 */
	 ...
	 *
	 * @see find
	 * @return AR_model The last matched record or null if not found
	 */
