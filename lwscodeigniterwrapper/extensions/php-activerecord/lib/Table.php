...
class Table
{
	...
	public function __construct($class_name)
	{
		...
		$this->callback->register('before_save', function(AR_model $model) { $model->set_timestamps(); }, array('prepend' => true));
		$this->callback->register('after_save', function(AR_model $model) { $model->reset_dirty(); }, array('prepend' => true));
	}
