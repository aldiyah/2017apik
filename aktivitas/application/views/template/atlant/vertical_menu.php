...
<li class="xn-icon-button pull-right">
    <?php if ($is_authenticated): ?>
        ...
        <a href="<?php echo base_url('logout'); ?>" data-box="#mb-signout"><span class="fa fa-sign-out"></span> Keluar</a>
        <!-- END SIGN OUT -->
    <?php else: ?>
        <!--<a href="<?php echo base_url('login'); ?>" data-box="#mb-signout"><span class="fa fa-sign-in"></span></a>-->
        <a href="<?php echo base_url('login'); ?>" data-box="#mb-signout"><span class="fa fa-sign-in"></span> Masuk</a>
    <?php endif; ?>
</li>
<?php
/**
