                            ...
                            <?php if ($records != FALSE): ?>
                                <?php foreach ($records as $key => $record): ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $jenis_status[$record->cuti_status] ?></td>
                                        <td class="text-center">
                                            <?php if ($record->cuti_status == 0): ?>
                                                <div class="btn-group btn-group-sm">
                                                    <a class="btn btn-default" href="<?php echo base_url("back_end/" . $active_modul . "/detail") . "/" . $record->cuti_id; ?>">Ubah</a>
                                                    <a class="btn btn-default" href="<?php echo base_url("back_end/" . $active_modul . "/ajukan") . "/" . $record->cuti_id; ?>">Ajukan</a>
                                                    <a class="btn btn-default btn-hapus-row" href="javascript:void(0);" rel="<?php echo base_url("back_end/" . $active_modul . "/delete") . "/" . $record->cuti_id; ?>">Hapus</a>
                                                </div>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
