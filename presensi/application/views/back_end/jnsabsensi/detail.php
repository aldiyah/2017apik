            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 col-xs-12 control-label">Nama Absensi</label>
                        <div class="col-md-6 col-xs-12">
                            <input type="text" name="absensi_nama" id="txt-absensi_nama" class="form-control" value="<?php echo $detail ? $detail->absensi_nama : ""; ?>">                               
