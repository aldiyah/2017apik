    ...
    <div class="row">
            ...
            <div class="col-md-4">
                <div class="widget widget-success widget-item-icon">
                    ...
                    <div class="widget-data">
                        ...
                        <div class="widget-title">TPP SKP</div>
                        <div class="widget-subtitle">Estimasi TPP dari SKP Anda bulan ini</div>
                    </div>
                </div>
            </div>
        </a>
        <div class="col-md-4">
            <div class="widget widget-default widget-item-icon">
                ...
                <div class="widget-data">
                    <div class="widget-int"><?php echo _format_number($total_skp_diterima, 0); ?></div>
                    <div class="widget-title">SKP Bulanan Diterima</div>
                    <div class="widget-subtitle">Jumlah SKP Anda yang telah diterima bulan ini</div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="widget widget-danger widget-item-icon">
                ...
                <div class="widget-data">
                    <div class="widget-int"><?php echo _format_number($total_skp_ditolak, 0); ?></div>
                    <div class="widget-title">SKP Bulanan Ditolak</div>
                    <div class="widget-subtitle">Jumlah aktivitas Anda yang diterima bulan ini</div>
                </div>
            </div>
        </div>
        <div class="col-md-12">
