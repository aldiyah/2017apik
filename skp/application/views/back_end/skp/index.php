...
$status = array('Draft', 'Pengajuan', 'Proses', 'Ditolak', 'Selesai');
$label = array('label-warning', 'label-default', 'label-danger', 'label-primary', 'label-success');
                            ...
                            <?php if ($records != FALSE): ?>
                                <?php foreach ($records as $key => $record): ?>
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo $record->skpt_kredit ?></td>
                                        <td class="text-right"><span class="pull-left">Rp. </span><?php echo _format_number($record->skpt_biaya, 0) ?></td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <?php else: ?>
                                                    <a class="btn btn-default" href="<?php echo base_url("back_end/" . $active_modul . "/read") . "/" . $record->skpt_id; ?>">Lihat</a>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                    </tr>
