                        ...
                        <div id="step-1">   
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    echo dropdown_tahun('skpt_tahun', $default_value_tahun, 5, 'class="form-control select"');
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">                                            
                                    <?php echo form_input('skpt_waktu', set_value('skpt_waktu', $detail ? $detail->skpt_waktu : ''), 'class="form-control"'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">                                            
                                    <?php echo form_input('skpt_kuantitas', set_value('skpt_kuantitas', $detail ? $detail->skpt_kuantitas : ''), 'class="form-control"'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">                                            
                                    <?php echo form_input('skpt_kualitas', set_value('skpt_kualitas', $detail ? $detail->skpt_kualitas : ''), 'class="form-control"'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">                                            
                                    <?php echo form_input('skpt_biaya', set_value('skpt_biaya', $detail ? $detail->skpt_biaya : ''), 'class="form-control"'); ?>
                                    <span class="help-block">Isikan dengan biaya yang akan dikeluarkan untuk kegiatan ini.</span>
                                </div>
                            </div>
                        </div>
                        <div id="step-2">
