                    ...
                    <table class="table-condensed table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo form_input('skpb_real_kuantitas', set_value('skpb_real_kuantitas', $detail ? $detail->skpb_real_kuantitas : 0), 'class="form-control"'); ?></td>
                            </tr>
                            <tr>
                                <td>Biaya</td>
                                <td class="text-center"><?php echo $detail->skpb_biaya ?></td>
                                <td><?php echo form_input('skpb_real_biaya', set_value('skpb_real_biaya', $detail ? $detail->skpb_real_biaya : 0), 'class="form-control"'); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
